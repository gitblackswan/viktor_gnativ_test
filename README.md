...
* При возникновении трудностей тех.директор помагает решить проблему
...
* Уметь повторять/выпонять функционал, указанный в ТЗ/примере
...
* Если до 18.00 сегодняшнего дня вы не заполнили отчет за вчера - проект передается другому.

* Вы должны ежедневно выходить на связть, если вы пропали без предупреждения/уведомления - проект передается другому.
...
* Разработка приоритетно на стандартных плагинах, исходники которога лежат в стандартной папке проекта(они поверглис изменений).
...
* При работе над страницой нужно соблюдать стандарт подключения ресурсов https://gist.github.com/play0for0fun/7c8ee3fe3cd03dd84db75a0ac940c333
...
* Вместе с данными с формой должны приходить данные идентификации, все выбранные параметры и данные относящийся к этой форме, стандартные ютм метки и геоданные
